...
7. You have made changes to a file in your local repository. We now want to push our changes to GitHub. To do so, in GitKraken, you should now add, commit, and finally push your changes. If you refresh GitHub, the changes you've made should now be on 
